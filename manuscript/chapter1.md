...
## What you will Learn
In this book, we will be taking an exampled-based approach to web application development. The book will show you how to design a web application called *Rango* ([see the Design Brief below](#overview-design-brief-label)). Along the way, we'll show you how to perform the following key tasks which are common to most software engineering projects.
