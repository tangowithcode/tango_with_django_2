...
I> ### Are you using Git?
I> You can do this chapter independently as we have already implemented Rango -- our implementation is [available from GitHub](https://github.com/maxwelld90/tango_with_django_2_code). If you haven't used Git/GitHub before, you can check out our [chapter on using Git](#chapter-git).
